...
export default class ShoesStore extends Component {
    ...
    viewDetail = (shoeClick) => {
        let newShoe = shoeClick
        this.setState({
            shoeDetail: newShoe
        })
    }
    ...
    render() {
        return (
            <div>
                <h3 className="text-center p-5 bg-dark text-light">SHOES STORE</h3>
                <ProductList data={data} viewDetail={this.viewDetail} />
                <Modal shoeDetail={this.state.shoeDetail} />
            </div>
        )
    }
}
